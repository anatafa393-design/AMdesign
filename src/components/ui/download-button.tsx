...
export default function DownloadButton({ href, projectTitle, label }: DownloadButtonProps) {
  const handleDownload = () => {
    trackPixelEvent("Lead", {
      content_name: "PDF Document Download",
      project: projectTitle,
    });
  };

  const defaultLabel = projectTitle.toLowerCase().includes("profile")
